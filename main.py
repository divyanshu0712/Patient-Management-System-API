...
class Patient(BaseModel):
    ...
    name:Annotated[str,Field(...,description='Name of patient')] #Annotated is used for description example etc
...
class PatientUpdate(BaseModel):
    name:Annotated[Optional[str],Field(default=None)] #Annotated is used for description example etc
...
def view_patients(patient_id: str = Path(..., description='Patient ID')):
    data = load_data()
...
@app.get('/sort')
def sorted_patients(
    sort_by: str = Query(..., description='Sort by age or weight'),
    order: str = Query('asc', description='asc or desc')
):
    valid_fields = ['weight', 'age'] 
